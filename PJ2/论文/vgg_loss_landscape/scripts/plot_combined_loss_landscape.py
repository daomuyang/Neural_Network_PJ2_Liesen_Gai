...
def plot_learning_rate_effect(save_path):
    ...
    lrs = ['2e-3', '1e-4', '5e-4', '1e-3']
    colors = ['#ff7f0e', '#2ca02c', '#d62728', '#9467bd']
    vgg_a_exps = ['vgg_a_lr002', 'vgg_a_lr0001', 'vgg_a_lr0005', 'vgg_a_lr001']
    vgg_a_bn_exps = ['vgg_a_bn_lr002', 'vgg_a_bn_lr0001', 'vgg_a_bn_lr0005', 'vgg_a_bn_lr001']
